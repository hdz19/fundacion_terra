...
if(!empty($_POST))
	{
		$alert='';
		if(empty($_POST['Estado_Orden_Compra']) )
		{
			$alert='<p class="msg_error">Todos los campos son obligatorios.</p>';
		}else{

    
			$estado_compra= $_POST['Estado_Orden_Compra'];
			


		

            $consulta = mysqli_query($conexion,"INSERT INTO tlb_estado_orden_compra (Estado_Orden_Compra)
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Panel de Control</li>
                                   ...
                                   <center> <h1> Estado de orden de compra</h1></center>
            

				<label for="Estado_Orden_Compra">Estado orden compra </label>
				<input class="form-control" type="text" onKeyUP="this.value=this.value.toUpperCase();" name="Estado_Orden_Compra" id="Estado_Orden_Compra" placeholder="Ingrese el estado"
                onkeypress="return  SoloLetras_Espacio_uno(event)" maxlength="100" >
                                        ...
                                        <center> 
                                                    <button type="submit" name="orden" class="btn_save" >Enviar estado </button></div>
