...
<head>
	...
	<body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Lista Tipo de Actividades</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Lista Tipo de Actividades
                            </div>
							<div class="col-md-6"> <a href="tipo_actividad.php" class="btn_new">Nuevo Tipo de Actividad</a>


</div>
							<right>     <form action="buscar_tipo_actividad.php" method="get" class="form_search">
        ...
        $conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");	
			...
			$query = mysqli_query($conexion,"SELECT Id_Tipo_Actividad, Tipo_Actividad FROM tbl_tipo_actividad  
										WHERE 
										( Id_Tipo_Actividad LIKE '%$busqueda%' OR 
                                        Tipo_Actividad LIKE '%$busqueda%' ) 
