...
<head>
	...
	<body class="sb-nav-fixed">
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Lista Estado de Solicitudes
                            </div>
							<div class="col-md-6"> <a href="estado_solicitud.php" class="btn_new">Nuevo Estado</a>


</div>
							<right>     <form action="buscar_estado_solicitud.php" method="get" class="form_search">
        ...
        $conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");	
			...
			$query = mysqli_query($conexion,"SELECT Id_Estado, Estado FROM tbl_estado 
										WHERE 
										( Id_Estado LIKE '%$busqueda%' OR 
			...
			?>
				...
				<tr>
					...
					<td>
						<a class="link_edit" href="actualizar_estadoo_solicitud.php?id=<?php echo $data["Id_Estado"]; ?>">Editar</a>
