...
if (isset($_POST['Enlace'])) {
    ...
    if (strlen($_POST['enlace']) >= 1 && strlen($_POST['Id_Parametro']) >= 1  )
    {
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Panel de Control</li>
                                   ...
                                   <center> <h1>Ingrese URL de imagen</h1></center>
            

				<label for="enlace"> URL</label>
				<input class="form-control" type="text" onKeyUP="this.value=this.value.toUpperCase();" name="enlace" id="enlace" placeholder="Ingrese URL "
