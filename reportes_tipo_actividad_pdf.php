...
//se muestra fecha de imrpesion
    ...
    $this->Cell(45,10, "Tipo de Actividad", 1, 1, 'C', 0);
...
require 'cn.php';
$consulta =("SELECT Id_Tipo_Actividad ,Tipo_Actividad
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->Cell(45,10, $row["Id_Tipo_Actividad"], 1, 0, 'C', 0);  

    $pdf->Cell(45,10, $row["Tipo_Actividad"], 1, 1, 'C', 0);
