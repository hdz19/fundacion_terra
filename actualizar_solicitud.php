...
if($_SESSION['Id_Rol']!= 1)
    ...
    if (isset($_POST['Actualizar_Solicitud'])) {
        if ( strlen($_POST['Nombre_Completo']) >= 1 && strlen($_POST['Tipo_Solicitud']) >= 1 && strlen($_POST['Estado']) >= 1 && 
          strlen($_POST['Nombre_Proyecto']) >= 1 &&   strlen($_POST['Motivo']) >= 1  
...
$conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");
                    ...
                    //$conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");
					$sql_update = mysqli_query($conexion,"UPDATE tbl_solicitud  s
                    ...
                    t.Tipo_Solicitud='$tipo_solicitud', 
                    e.Estado=' $estado', 
    ...
    <body class="bg-primary">
        ...
        <div id="layoutSidenav">
            ...
            <center>  <form  action="" method="post">                                 
                ...
                <input width: 50px; class="form-control" type="text" style="width: 450px" name="Motivo" id="Motivo" onKeyUP="this.value=this.value.toUpperCase();" placeholder="Motivo" value="<?php echo $motivo; ?>"
				...
				<input class="form-control" style="width: 450px" type="text" onKeyUP="this.value=this.value.toUpperCase();" name="Nombre_Completo" id="Nombre_Completo" placeholder="Nombre Completo" value="<?php echo $nombre_completo; ?>"
                onkeypress="return  SoloLetras_Espacio_uno(event)" maxlength="100" >

                <label for="Tipo_Solicitud">Tipo de Solicitud</label>
				<input class="form-control" style="width: 450px" type="text" onKeyUP="this.value=this.value.toUpperCase();" name="Tipo_Solicitud" id="Tipo_Solicitud" placeholder="Tipo Solicitud " value="<?php echo $tipo_solicitud; ?>"
                onkeypress="return  SoloLetras_Espacio_uno(event)" maxlength="100" >

                <label for="Estado">Estado</label>
				<input class="form-control" style="width: 450px" type="text" onKeyUP="this.value=this.value.toUpperCase();" name="Estado" id="Estado" placeholder="Estado" value="<?php echo $estado; ?>"
                onkeypress="return  SoloLetras_Espacio_uno(event)" maxlength="100" >
                                           ...
                                           <div class="btn-group">
                                                    ...
                                                    <button type="submit" name="Actualizar_Solicitud" class="btn_save" >Actualizar </button></div>
