    ...
    <body class="sb-nav-fixed">
	    <section id="container">
           ...
           <div id="layoutSidenav">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                           ...
                           <div class="col-md-6"> <a href="contacto.php" class="btn_new"> Atras </a>
                        ...
                        <div class="card-body">
								...
								<tbody>
                                    <thead>
										...
										<?php 
			//Paginador
			$sql_registe = mysqli_query($conexion,"SELECT COUNT(*) as total_registro FROM tbl_contacto ");
			...
			$query = mysqli_query($conexion,"SELECT u.Id_Contacto, u.Id_Personas, u.Id_Tipo_Contacto 
                                            FROM tbl_contacto u 
			                                ORDER BY u.Id_Contacto ASC LIMIT $desde,$por_pagina ");
			...
			?>
				<tr>
					<td><?php echo $data["Id_Contacto"]; ?></td>
					<td><?php echo $data["Id_Personas"]; ?></td>
					<td><?php echo $data["Id_Tipo_Contacto"]; ?></td>
					

					<td>
						<a class="link_edit" href="editar_contacto.php?id=<?php echo $data["Id_Contacto"]; ?>">Editar</a>

					<?php if($data["Id_Contacto"] != 1){ ?>
						|
						<a class="link_delete" href="eliminar_contacto.php?id=<?php echo $data["Id_Contacto"]; ?>">Eliminar</a>
					<?php } ?>
