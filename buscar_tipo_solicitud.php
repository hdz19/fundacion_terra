...
<head>
	...
	<body class="sb-nav-fixed">
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							...
							<div class="col-md-6"> <a href="tipo_solicitud.php" class="btn_new">Nuevo Tipo de Solicitud</a>


</div>
							<right>     <form action="buscar_tipo_solicitud.php" method="get" class="form_search">
        ...
        $conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");	
			...
			$query = mysqli_query($conexion,"SELECT Id_Tipo_Solicitud, Tipo_Solicitud FROM tbl_tipo_solicitud  
										WHERE 
										( Id_Tipo_Solicitud LIKE '%$busqueda%' OR 
											Tipo_Solicitud LIKE '%$busqueda%' ) 
                                            ORDER BY Id_Tipo_Solicitud	");
			mysqli_close($conexion);
