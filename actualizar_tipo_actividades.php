...
if($_SESSION['Id_Rol']!= 1)
	...
	{
		$alert='';
		if(  empty($_POST['Tipo_Actividad']) >= 1 )
		{
...
$conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");
                    ...
                    //$conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");
					$sql_update = mysqli_query($conexion,"UPDATE tbl_tipo_actividad SET Id_Tipo_Actividad='$id_tipo_actividad',Tipo_Actividad='$tipo_actividad'
                     WHERE Id_Tipo_Actividad='$id_tipo_actividad'");
               if($sql_update){
                    
					$alert='<p class="msg_save">Tipo de Actividad actualizado correctamente.</p>';
                    ?> 
                    <script type="text/javascript">
                              alert('¡ Tipo de Actividad actualizado correctamente !')
            ...
            ?> 
                   <?php
					...
					$alert='<p class="msg_error">Error al actualizar el Tipo de Actividad .</p>';
				}
...
$conexion=mysqli_connect("localhost","root","","bdd_fundacion_terra");
$sql= mysqli_query($conexion,"SELECT Id_Tipo_Actividad, Tipo_Actividad
    ...
    <body class="bg-primary">
        ...
        <div id="layoutSidenav">
            ...
            <center>  <form  action="" method="post">                                 
                            ...
                            <tr>                    
                              <td>  <input width: 50px; class="form-control" type="text" style="width: 450px" name="Tipo_Actividad" id="Tipo_Actividad" onKeyUP="this.value=this.value.toUpperCase();" placeholder="Tipo Solicitud" value="<?php echo $tipo_actividad; ?>"
                onkeypress="return  SoloLetras(event)" maxlength="15"  ></td>
                                           ...
                                           <div class="btn-group">
                                                    ...
                                                    <button type="submit" name="Actualizar Tipo Actividad" class="btn_save" >Actualizar </button></div>
